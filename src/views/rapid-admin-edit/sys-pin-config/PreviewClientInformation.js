...
import {  REPORT_BREAK_OPTIONS, SEARCH_TYPE_OPTIONS } from './field-value-mapping';
import FormControlLabel from '@mui/material/FormControlLabel';
import Checkbox from '@mui/material/Checkbox'

const PreviewClientInformation = ({ selectedGroupRow, setEditClientWindow, selectedData }) => {
  ...
  return (
    <>
        ...
        <CCardBody
            ...
            <CCol style={{  display: 'flex', alignItems: 'center', justifyContent: 'flex-start',  paddingLeft: '4px', flex:'0 0 40%', maxWidth: '40%' }}>
                ...
                <CCol style={{  display: 'flex', alignItems: 'center', justifyContent: 'flex-start',  paddingLeft: '4px', flex:'0 0 60%', maxWidth: '60%' }}>
                    {/* Checkboxes */}
                    <FormControlLabel
                    control={<Checkbox size="small" checked={selectedGroupRow?.positiveReports || ''} onChange={handleCheckboxChange('active')} disabled={!isEditable} />}
            ...
            <CCol style={{  display: 'flex', alignItems: 'center', justifyContent: 'flex-start',  paddingLeft: '4px', flex:'0 0 40%', maxWidth: '40%' }}>
                ...
                <CCol style={{  display: 'flex', alignItems: 'center', justifyContent: 'flex-start',  paddingLeft: '4px', flex:'0 0 60%', maxWidth: '60%' }}>
                    <FormControlLabel
                    control={<Checkbox size="small" checked={selectedGroupRow?.excludeFromReport || ''} onChange={handleCheckboxChange('active')} disabled={!isEditable} />}
            ...
            <CCol style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start', paddingLeft: '4px' }}>
                    <FormControlLabel
                    control={<Checkbox size="small" checked={selectedGroupRow?.amexIssued || ''} onChange={handleCheckboxChange('active')} disabled={!isEditable} />}
      ...
      <CCard style={{ height: '150px', marginBottom: '4px', marginTop: '15px' }}>
        ...
        >
          <div style={{ width: '100%', height: '100%' }}>
            <ClientEmails data={selectedGroupRow?.clientEmail || []} />
          </div>
        </CCardBody>
      </CCard>
